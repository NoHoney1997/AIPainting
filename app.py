...
STAGE_NAMES = {
    ...
    "A2a": "内心独白", "A2b": "声音来源", "A2c": "困难认知", "A2d": "内心声音对比",
    "A3a": "挑选瞬间", "A3b": "生成漫画", "A3c": "确认漫画",
    "B1a": "人际困扰", "B1b": "具体情境", "B1c": "角色反应", "B1d": "后续影响",
    "B2a": "内心独白", "B2b": "声音来源", "B2c": "困难认知", "B2d": "内心声音对比",
...
STAGE_GOALS = {
    ...
    "A1a": "引导用户描述角色在工作或学业方面遇到的困扰，并追问身体反应",
    "A1b": "追问具体场合和角色内心的第一反应原话",
    "A1c": "追问角色行为反应，并引导联想他人的普遍性",
    "A1d": "追问事件影响，引导区分意外与自我评判",
    "A2a": "引导用户写出角色对自己说的安抚话语",
    "A2b": "引导判断角色是否陷入孤立感",
    "A2c": "引导判断角色是被痛苦困住还是能觉察",
    "A2d": "引导判断角色内心鼓励声和批评声的占比",
    "A3a": "回顾之前的故事素材，引导用户挑选3-5个关键瞬间",
    "A3b": "由代码逐格生成连环画，不通过LLM",
    "A3c": "简短确认，过渡到人际故事",
    "B1a": "引导用户描述角色在人际方面遇到的困扰，并追问身体反应",
    "B1b": "追问具体场合和角色内心的第一反应原话",
    "B1c": "追问角色行为反应，引导联想他人的普遍性",
    "B1d": "追问事件影响，引导区分意外与自我评判",
    "B2a": "引导用户写出角色对自己说的安抚话语",
    "B2b": "引导判断角色是否陷入孤立感",
    "B2c": "引导判断角色是被痛苦困住还是能觉察",
    "B2d": "引导判断角色内心鼓励声和批评声的占比",
...
STAGE_REFS = {
    ...
    "A1a": "每个人都会遇到各种状况——{name}在{work_or_study}方面有没有什么让TA感到困扰或沮丧的事？那件事发生的时候，TA身体哪个部位最先有反应？具体是什么感觉？",
    "A1b": "能再说具体一点吗？当时TA心里冒出来的第一个念头是什么——原话是什么？",
    "A1c": "当时{name}做了什么？或者有什么想做的但没做？TA有没有想过'别人遇到这种事会怎么想'？",
    "A1d": "这件事之后对{name}有什么影响？TA会觉得'这只是个意外'，还是'果然暴露了我的问题'？——或者TA是别的看法？",
    "A2a": "如果{name}要安抚困境中的自己，会对TA自己说一句什么话？",
    "A2b": "TA会觉得'只有我才会这样'，还是'谁都可能遇到'？",
    "A2c": "在{name}看来，TA是'完全被痛苦困住'，还是能意识到'我正在经历困难'？",
    "A2d": "夜深人静时，TA内心那个音量最大的声音——是'你辛苦了'，还是'你活该'？",
    "A3a": "刚才描述了{name}的故事。现在用AI生成连环画。挑3个及以上的关键瞬间，每格描述具体的场景、{name}的状态和感受。",
    "A3b": "正在生成连环画...",
    "A3c": "{work_or_study}故事的连环画完成了。接下来我们来探索{name}在人际关系方面的故事。",
    "B1a": "除了{work_or_study}，日常中人际关系也很重要——{name}在人际方面有没有什么困扰？那件事发生的时候，TA身体哪个部位最先有反应？具体是什么感觉？",
    "B1b": "能再说具体一点吗？当时TA心里冒出来的第一个念头是什么——原话是什么？",
    "B1c": "当时{name}做了什么？TA有没有想过'别人会怎么处理这种事'？",
    "B1d": "这件事之后对{name}有什么影响？TA会觉得'只是个意外'，还是'果然我处理不好关系'？",
    "B2a": "如果{name}要安抚困境中的自己，会对TA自己说什么？",
    "B2b": "TA会觉得'只有我才会这样'，还是'谁都可能遇到'？",
    "B2c": "在{name}看来，TA是'完全被痛苦困住'，还是能意识到'我正在经历困难'？",
    "B2d": "夜深人静时，TA内心那个音量最大的声音——是'你辛苦了'，还是'你活该'？",
...
ACADEMIC_TARGETS = [
    ...
    "self_kindness", "common_humanity", "mindfulness", "self_kindness_deep",
...
TARGET_NAMES = {
    "story_dilemma": "核心困扰（含身体反应）",
    "story_context": "具体情境（含内心原话）",
    "story_reaction": "行为反应（含他人联想）",
    "story_impact": "后续影响（含归因判断）",
    "self_kindness": "自我安抚话语",
    "common_humanity": "孤立感判断",
    "mindfulness": "痛苦觉察状态",
    "self_kindness_deep": "内心声音对比",
    "comic_frames": "连环画分镜",
    "comic_confirmed": "连环画确认",
}

TARGET_DESCRIPTIONS = {
    "story_dilemma": "描述角色遇到的困扰，包括身体反应细节",
    "story_context": "描述具体情境和角色内心的第一反应原话",
    "story_reaction": "描述角色的行为反应，是否联想到他人的普遍性",
    "story_impact": "描述事件影响，区分意外事件与自我评判",
    "self_kindness": "写出角色对自己说的安抚话语",
    "common_humanity": "判断角色是否认为'只有我这样'",
    "mindfulness": "判断角色是被痛苦淹没还是能觉察到'我正在经历困难'",
    "self_kindness_deep": "判断角色内心鼓励声音与批评声音的占比",
...
TARGET_SUFFICIENCY_CRITERIA = {
    ...
    "story_dilemma": "用户说明了角色具体的困扰并描述了身体反应，有实质内容",
    "story_context": "用户补充了具体场合和角色内心第一反应的原话，能让场景成形",
    "story_reaction": "用户描述了角色的行为反应，并提及是否联想到他人",
    "story_impact": "用户说明了实际影响，并对事件有归因判断",
    "self_kindness": "用户给出了角色对自己说的安抚话语，带有具体内容",
    "common_humanity": "用户对'是否只有自己这样'有明确判断",
    "mindfulness": "用户明确描述了角色是被困住还是能觉察到自己在经历困难",
    "self_kindness_deep": "用户对鼓励声音和批评声音的占比有具体描述，包含各自的原话",
...
TARGET_COLLECT_PROMPTS = {
    ...
    "story_dilemma": "角色遇到了什么困扰？身体哪个部位有反应？",
    "story_context": "具体场合、人物、细节，以及角色内心冒出来的第一句原话",
    "story_reaction": "角色做了什么，是否想过别人会怎么应对",
    "story_impact": "事件之后的实际影响，以及'这只是意外'还是'暴露了我的问题'的判断",
    "self_kindness": "角色对自己说的安抚话语",
    "common_humanity": "角色觉得'只有我这样'还是'谁都可能遇到'",
    "mindfulness": "角色是'完全被痛苦困住'还是能'意识到自己在经历困难'",
    "self_kindness_deep": "角色内心鼓励声和批评声哪个更大，各说了什么",
...
TARGET_TO_STAGE_MAPPING = {
    CONTEXT_ACADEMIC: {
        ...
        "mindfulness": "A2c", "self_kindness_deep": "A2d",
        "comic_frames": "A3a", "comic_confirmed": "A3c",
    },
    CONTEXT_SOCIAL: {
        "story_dilemma": "B1a", "story_context": "B1b", "story_reaction": "B1c",
        "story_impact": "B1d", "self_kindness": "B2a", "common_humanity": "B2b",
        "mindfulness": "B2c", "self_kindness_deep": "B2d",
        "comic_frames": "B3a", "comic_confirmed": "B3c",
    },
}
...
TARGET_GUIDES = {
    CONTEXT_ACADEMIC: {
        ...
        "self_kindness_deep": STAGE_REFS["A2d"],
    ...
    CONTEXT_SOCIAL: {
        ...
        "self_kindness_deep": STAGE_REFS["B2d"],
...
返回JSON：{{"appearance": ""}}""",
        ...
        "A2d": """提取角色内心鼓励声和批评声的对比。返回JSON：{{"self_kindness_deep": ""}}""",
        ...
        "B2d": """提取角色内心鼓励声和批评声的对比。返回JSON：{{"self_kindness_deep": ""}}""",
...
def store_data(stage: str, user_input: str):
    ...
    if stage == "S0a":
        ...
        st.session_state.stage_A2d_self_kindness_deep = extracted.get("self_kindness_deep") or extracted.get("_raw") or user_input
    elif stage == "B2d":
        st.session_state.stage_B2d_self_kindness_deep = extracted.get("self_kindness_deep") or extracted.get("_raw") or user_input
    elif stage == "DEBRIEF":
...
def save_session():
    ...
    session_data = {
        ...
        "stage_A2d_self_kindness_deep": st.session_state.get("stage_A2d_self_kindness_deep", ""),
        "stage_B2d_self_kindness_deep": st.session_state.get("stage_B2d_self_kindness_deep", ""),
...
def load_session_to_state(session_id: str):
    ...
    st.session_state.stage_A2d_self_kindness_deep = session_data.get("stage_A2d_self_kindness_deep", "")
    st.session_state.stage_B2d_self_kindness_deep = session_data.get("stage_B2d_self_kindness_deep", "")
...
def init_session_state():
    ...
    if "stage_A2d_self_kindness_deep" not in st.session_state:
        st.session_state.stage_A2d_self_kindness_deep = ""

    if "stage_B2d_self_kindness_deep" not in st.session_state:
        st.session_state.stage_B2d_self_kindness_deep = ""

    if "stage_quote_timestamp" not in st.session_state:
